...
public class DisplayLeaderboardCommand extends SokobanCommand {
	
	Model model;
	View view;
	
	public DisplayLeaderboardCommand(Model model, View view) {
	...
	public void execute() {
		...
		view.DisplayLeaderboard(leaderboard,userName,levelName,orderBy,firstIndex,maxResults);
